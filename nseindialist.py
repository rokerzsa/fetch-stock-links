...
# Get Cursor
cur = conn.cursor()
securities_list = {"20MICRONS":	"20 Microns Limited",
                   ...
                   "KPIGLOBAL":	"K.P.I. Global Infrastructure Limited",
                   ...
                   "MODISNME":	"Modison Metals Limited",
                   ...
                   "NGIL-RE":	"Nakoda Grp of Ind Ltd-RE",
                   ...
                   "VLIFEPP":	"Vikas Lifecare Limited",
...
for key in securities_list:
    sym = key
    com_name = securities_list[key]
    try:
            cur.execute("INSERT INTO securities_list (symbol,company_name) VALUES (?,?)",
                        (sym, com_name)
            )
    except mariadb.Error as e:
            print(f"Error: {e}")
